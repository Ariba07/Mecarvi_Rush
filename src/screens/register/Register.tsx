...
import {updateField} from '../../slice/Slice';
...
const Register = () => {
  ...
  const handleNext = (values: {
    ...
    dispatch(updateField({field: 'fullName', value: values.name}));
    dispatch(updateField({field: 'email', value: values.email}));
    dispatch(updateField({field: 'phoneNumber', value: values.phoneNumber}));
